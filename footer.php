			...
			<footer id="site-footer">
				...
				<div class="footer-inner section-inner">
					...
					<div class="footer-credits">
						...
						<p class="footer-copyright">&copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'grand4you' ) ) ); ?> <a href="<?php echo esc_url( home_url() ); ?>" rel="home"><?php echo bloginfo( 'name' ); ?></a></p>

						<p class="theme-credits color-secondary">
							<a href="https://github.com/strYchni0x/grand4you">grand4you</a>
						</p><!-- .theme-credits -->
